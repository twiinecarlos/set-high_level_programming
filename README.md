...
- `python-if_else_loops_functions` - conditionals, loops, and functions
- `python-import_modules` - importing modules and scripts
- `python-more_data_structures` - lists, sets, dictionaries, and C/Python API
- `python-classes` - object-oriented programming with classes
- `python-more_classes` - advanced class features (repr, del, class attributes)
